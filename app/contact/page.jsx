    ...
    <div> {/* Outer div might be needed for layout/styling */}
      <div className="min-h-screen bg-background text-foreground font-sans"> {/* Added font-sans here */}
        ...
        <main className="pt-24 pb-20 px-6 max-w-4xl mx-auto space-y-12">
          ...
          {/* Send Us an Email Button (Optional - you might remove this if you have the form) */}
          {/*
          ...
          */}
          ...
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.2 }} // Keep original delay
            className="bg-background border border-cta rounded-2xl shadow-xl p-8 space-y-6 mt-12" // Added margin-top
          >
            <h2 className="text-2xl font-semibold text-primary">
          ...
          <div className="text-center pt-8">
             <Link href="/" passHref>
               <button
                 type="button"
                 className="text-foreground text-lg hover:text-cta transition-colors flex items-center gap-2 mx-auto"
                 aria-label="Back to Home"
               >
                 ← Back to Home
               </button>
